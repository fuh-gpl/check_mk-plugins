...
$opt[1] = "--vertical-label 'active locks' -l0 -u $CRIT[1] --title \"$title\" ";

$def[1] = "DEF:locks=$RRDFILE[1]:$DS[1]:MAX ";
$def[1] .= "AREA:locks#00ff48: ";
$def[1] .= "LINE:locks#008f38: ";
$def[1] .= "GPRINT:locks:LAST:\"last\: %3.0lf\" ";
$def[1] .= "GPRINT:locks:AVERAGE:\"avg\: %3.0lf\" ";
$def[1] .= "GPRINT:locks:MAX:\"max\: %3.0lf\" ";
